  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form :inline="true" :model="listQuery" class="form-inline">
        ...
        <el-form-item label="">
          <el-input v-model="listQuery.password" placeholder="密码" clearable size="small" />
        </el-form-item>
        <el-form-item label="">
          <el-input v-model="listQuery.interface_name" placeholder="接口名" clearable size="small" />
        </el-form-item>
        <el-form-item label="">
    ...
    >
      ...
      <el-table-column label="密码" width="250px" align="center">
      <template slot-scope="scope">
        <span>{{scope.row.password}}</span>
      </template>
      </el-table-column>
      <el-table-column label="接口名" width="200px" align="center">
        <template slot-scope="scope">
          <span>{{scope.row.interface_name}}</span>
        </template>
      </el-table-column>
      <el-table-column label="wordpress接口" min-width="100px" align="center">
        <template slot-scope="scope">
...
<script>
  import { getList, del, change, delAll, changeAll } from '@/api/information'
  import waves from '@/directive/waves'

  import { getArrByKey } from '@/utils'
  import cdetailForm from './information/form'
