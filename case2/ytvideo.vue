  ...
  <div class="app-container">
    ...
    <el-row style="margin-bottom: 10px;">
      <el-col :xs="24" :sm="24" :lg="24">
        ...
        <el-tooltip content="观看人数降序" placement="top">
    ...
    >
      ...
      <el-table-column label="视频链接" width="330px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="频道标题" width="150px" align="center" :show-overflow-tooltip="true">
        <template slot-scope="scope">
      ...
      <el-table-column label="视频标题" min-width="190px" align="center" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          <span>{{scope.row.title}}</span>
        </template>
      </el-table-column>
      <el-table-column label="封面" width="70px" align="center">
        <template slot-scope="scope">
    ...
    <!-- 表单 -->
    <detailForm ref="fromDetail" />

  </div>
</template>

<script>
  import { getList, del, delAll } from '@/api/ytvideo'
  import waves from '@/directive/waves'
  import { pickerOptions, getArrByKey } from '@/utils'
  import detailForm from './ytvideo/form'
