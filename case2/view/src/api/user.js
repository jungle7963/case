...
export function getVersion(query) {
  return request({
    url: '/admin/admin/getversion',
    method: 'post',
    data: query
  })
}

export function editVersion(query) {
  return request({
    url: '/admin/admin/editversion',
    method: 'post',
    data: query
  })
}
